...
import {Button, Container, Fab, Header, Icon, Left, ListItem, Right, Title, Item, Label, Input} from 'native-base'
...
class ProfileScene extends Component {
  ...
  onChangeContactNumber = (text) => {
    this.props.setContactNumber(text)
  }
    ...
    return (
      <KeyboardAwareScrollView extraScrollHeight={100} style={styles.container} enableOnAndroid={true}>
        <View style={{flex: 1, padding: 16}}>
          ...
          <Item floatingLabel style={styles.item}>
            <Label style={{color: '#b4b4b4'}}>{I18n.t('settings.contact_number')}</Label>
            <Input style={styles.input} onChangeText={this.onChangeContactNumber}
