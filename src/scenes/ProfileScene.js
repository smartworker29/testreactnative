...
class ProfileScene extends Component {
  ...
  async componentDidMount() {
    ...
    this._isMounted && this.setState({fields: this.props.fields})
    this._isMounted && this.props.navigation.setParams({
  ...
  async loadStoredFields() {
    ...
    if (fields) {
      ...
      this._isMounted && this.setState({storedFields: Map(fieldsData)})
    }
  }
