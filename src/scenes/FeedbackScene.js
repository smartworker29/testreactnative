...
class FeedbackScene extends Component {
  ...
  onShowKeyboard = (data) => {
    this._isMounted && this.setState({keyboardHeight: data.endCoordinates.height});
  };

  onHideKeyboard = (data) => {
    this._isMounted && this.setState({keyboardHeight: 0, focus: false});
  };
    ...
    return (
      <View style={styles.container}>
        <TextInput multiline={true} underlineColorAndroid="transparent"
                   ...
                   onChangeText={this.changeText} value={this.state.text}
