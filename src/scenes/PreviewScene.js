...
class PreviewScene extends Component {
  ...
  rePhotoCallback = async (photoUri) => {
    if (!photoUri) {
      return this._isMounted && this.setState({renderSwiper: true});
    }
    ...
    this._isMounted && this.setState({photoUri, initIndex: photoIndex, renderSwiper: false}, () => {
      this.props.navigation.setParams({
        count: photos.count(),
        index: photoIndex,
        photo
      });
      this._isMounted && this.setState({renderSwiper: true})
    });
  ...
  initData = () => {
    ...
    this.props.navigation.setParams({
      ...
      rePhoto: (photo) => {
        this._isMounted && this.setState({renderSwiper: false});
